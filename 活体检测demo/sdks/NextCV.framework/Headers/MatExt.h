...
namespace ncv {
    ...
    static ncv::Mat getRotationMatrix2Df(ncv::Point2f center, double angle, double scale)
    {
        angle *= 3.14159265 / 180;
        double alpha = cos(angle)*scale;
        double beta = sin(angle)*scale;
        
        ncv::Mat M(2, 3, CV_32FC1);
    ...
    static ncv::Mat getRotationMatrix2D( ncv::Point2f center, double angle, double scale )
    {
        angle *= 3.14159265/180;
        double alpha = cos(angle)*scale;
        double beta = sin(angle)*scale;
    ...
    static void invertAffineTransformf(const ncv::Mat& src, ncv::Mat& dst)
    {
    ...
    static void  invertAffineTransform(const ncv::Mat& matM, ncv::Mat& _iM)
    {
    ...
    static void transform_points(std::vector<ncv::Point2f>& points, const ncv::Mat& m)
    {
    ...
    static void warpaffine_bilinear_c1(const ncv::Mat& src, ncv::Mat& dst, const ncv::Mat& tm, const ncv::Size& size, int flags)
    {
    ...
    static void warpaffine_bilinear_c3(const ncv::Mat& src, ncv::Mat& dst, const ncv::Mat& tm, const ncv::Size& size, int flags)
    {
