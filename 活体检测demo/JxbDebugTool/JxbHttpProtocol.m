...
- (void)stopLoading {
    ...
    model.requestAllHTTPHeaderFields = [self.request.allHTTPHeaderFields description];
    model.responseAllHTTPHeaderFields = [httpResponse.allHeaderFields description];
