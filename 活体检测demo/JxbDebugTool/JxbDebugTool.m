...
@property (nonatomic, strong) JxbDebugWindow    *detailWindow;
...
- (void)showDebug {
    if (!self.debugVC) {
        ...
        nav1.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Http" image:nil selectedImage:nil];
        ...
        nav2.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"Crash" image:nil selectedImage:nil];
        ...
        self.detailWindow = [[JxbDebugWindow alloc] initWithFrame:[UIScreen mainScreen].bounds];
        self.detailWindow.rootViewController = self.debugVC;
        self.detailWindow.windowLevel = self.debugWin.windowLevel - 1;
        self.detailWindow.hidden = NO;
